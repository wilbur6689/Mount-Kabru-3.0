...
public class SellToBlacksmithView extends View {
    ...
    private void sellWeapon() {
        ...
        Item playerWeapon = MountKabru.getCurrentGame().getHero().getInventory().getWeaponSlot();
        ...
        if (playerWeapon != bareHands) {
            ...
            int attackValue = MountKabru.getCurrentGame().getHero().getInventory().getWeaponSlot().getAttackValue();
            MountKabru.getCurrentGame().getHero().setAttack(attackValue);
    ...
    private void sellArmor() {
        ...
        if (playerArmor != clothes) {
            gold += sellValue;
            MountKabru.getCurrentGame().getHero().setGold(gold);
            MountKabru.getCurrentGame().getHero().getInventory().setArmorSlot(Item.clothes);
            int defenseValue = MountKabru.getCurrentGame().getHero().getInventory().getArmorSlot().getDefenseValue();
            MountKabru.getCurrentGame().getHero().setDefense(defenseValue);
            this.console.println("It has been a pleasure doing business with you, bring me more items you don't want.");
        } else {
            this.console.println("You don't have anything I want, go away.");
        }
